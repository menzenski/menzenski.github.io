...
![Most common words in the 2013 State of the Union address]({{ stopwords_not_removed.png | asset_path }})
...
![Most common words in the 2013 State of the Union address, with stop words removed]({{ stopwords_removed.png | asset_path }})
